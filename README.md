...
充电支持：个人主页：🔗 [B站：赛博画师GZT](https://space.bilibili.com/702745384)
...
Use SDPA (PyTorch native attention, more stable)：启用 SDPA加速， 自行安装Flash Attention 2 等（可选）  
...
Flash Attention 2 加速需要 CUDA 工具包和 flash-attn 库，安装后自动启用。
